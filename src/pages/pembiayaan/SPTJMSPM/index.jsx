...
import { getListSPM, getPembuatanSPM } from "../components/axios/sptjs-spm";
...
const SPTJMSPM = () => {
  ...
  return (
    <div className="grid grid-cols-1">
      <Card title="Surat Pernyataan Tanggungjawab Mutlak SPM">
        <Tab.Group>
          ...
          {isLoading ? (
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <SptjmSpm listData={listDataList} />
              </Tab.Panel>
            </Tab.Panels>
          )}
        </Tab.Group>
