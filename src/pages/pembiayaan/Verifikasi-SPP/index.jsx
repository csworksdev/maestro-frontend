...
import {
  getSPPTerverifikasi,
  getVerifikasiSPP,
} from "../components/axios/verifikasi-spp";
import { getSppBatal, getSppDitolak } from "../components/axios/spp";
...
const VerifikasiSPP = () => {
  const [listDataVerifikasiSPP, setListDataVerifikasiSPP] = useState([]);
  const [listDataSPPTerverifikasi, setListDataSPPTerverifikasi] = useState([]);
  ...
  const loadData = () => {
    getVerifikasiSPP()
      .then((res) => {
        setListDataVerifikasiSPP(res.data.data);
      })
      .finally(() => setIsLoading(false));
    getSPPTerverifikasi().then((res) => {
      setListDataSPPTerverifikasi(res.data.data);
    });
      ...
      <Card title="Verifikasi SPP">
        <Tab.Group>
          ...
          {isLoading ? (
            ...
            <Tab.Panels>
              <Tab.Panel>
                <Verifikasi listData={listDataVerifikasiSPP} />
              </Tab.Panel>
              <Tab.Panel>
                <TerVerifikasi listData={listDataSPPTerverifikasi} />
              </Tab.Panel>
              <Tab.Panel>
